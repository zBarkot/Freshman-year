...
// helper function
//Precondition: hQueue is a handle to a valid priority queue opaque object.
//Postcondition: No changes will be made to any internals of the object. The value
//   in the priority-value pair(Node) will be printed in order of priority, with 
//   its associated priority printed in front of it.
